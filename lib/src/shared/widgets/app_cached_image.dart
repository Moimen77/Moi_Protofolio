...
class AppCachedImage extends StatelessWidget {
      ...
      return Skeletonizer(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: context.apptTheme.colorScheme.surfaceContainerHighest,
            borderRadius: borderRadius,
          ),
        ),
      );
  ...
  Widget _buildDefaultErrorWidget(BuildContext context) {
    return Container(
      ...
      height: height,
      color:
          context.apptTheme.colorScheme.errorContainer.withValues(alpha: 0.9),
      child: Center(
        child: Icon(
          Icons.broken_image_outlined,
          color: context.apptTheme.colorScheme.error,
        ),
      ),
    );
  }
